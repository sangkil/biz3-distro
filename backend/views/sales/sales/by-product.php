...
<p class="pull-right">
    <?=
    Html::a('<i class="fa fa-download"></i>', ['by-product-csv', 'SalesDtl[FrDate]' => $searchModel->FrDate, 'SalesDtl[ToDate]' => $searchModel->ToDate, 'SalesDtl[branch_id]'=>$searchModel->branch_id], [
