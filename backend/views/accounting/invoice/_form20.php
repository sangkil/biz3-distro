...
<div class="invoice-form">
    ...
    <div class="row">
        <div class="col-md-3">
            <?= $form->field($model, 'number')->textInput(['readonly' => true, 'style' => 'width:40%;'])->label('Number') ?>
            <?=
            (!$model->isNewRecord) ? $form->field($model->vendor, 'name')->textInput(['id' => 'invoice-vendor_name'])->label('Vendor Name') :
